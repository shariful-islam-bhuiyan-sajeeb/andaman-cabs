  ...
  return (
    <div>
      ...
      <div className="text-center xl:mt-10 lg:mt-8 md:mt-6 mt-4 w-full mx-auto  ">
        <button className="flex items-center justify-center mx-auto md:gap-x-2 gap-x-1 text-center lg:text-lg  sm:text-md text-sm lg:font-bold font-medium font-serif rounded  lg:px-6 md:px-4 px-2 lg:py-2 py-1 translate-all duration-500  bg-[#ffd000] hover:bg-gray-600 text-black hover:text-white">
          View all (14)
